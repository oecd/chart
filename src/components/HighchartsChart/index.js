...
const HighchartsChart = ({
  ...
  yAxisOrderOverride = '',
  maxNumberOfDecimals = '',
  maxNumberOfDecimalsXAxis = null,
  numberPrefix = null,
  numberPrefixXAxis = null,
  numberSuffix = null,
  numberSuffixXAxis = null,
  customTooltip = '',
  mapCountryDimension = '',
  ...
  const [createOptionsFuncForChartType, setCreateOptionsFuncForChartType] =
    useState(null);
  // Chart type for which createOptionsFuncForChartType was created
  const [createOptionsFuncChartType, setCreateOptionsFuncChartType] =
    useState(null);
  ...
  useEffect(() => {
    if (
      ...
      // Make sure whe create options function is up-to-date for the desired chart type
      createOptionsFuncChartType === chartType &&
      !R.isNil(parsedData) &&
      allHeightCalculationsHaveBeenDone
    ) {
...
HighchartsChart.propTypes = {
  ...
  maxNumberOfDecimalsXAxis: PropTypes.string,
  numberPrefix: PropTypes.string,
  numberPrefixXAxis: PropTypes.string,
  numberSuffix: PropTypes.string,
  numberSuffixXAxis: PropTypes.string,
  ...
  hideLineSymbols: PropTypes.bool,
